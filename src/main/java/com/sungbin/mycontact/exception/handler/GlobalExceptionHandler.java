package com.sungbin.mycontact.exception.handler;
...
import com.sungbin.mycontact.exception.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ErrorResponse handleRuntimeException(RuntimeException ex) {
        ...
        return ErrorResponse.of(HttpStatus.INTERNAL_SERVER_ERROR, "알수 없는 서버오류가 발생하였습니다.");
    }
